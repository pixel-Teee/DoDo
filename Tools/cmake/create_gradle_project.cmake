...
if(EXISTS ${ANDROID_MANIFEST})
    file(RELATIVE_PATH ANDROID_MANIFEST ${OUTPUT_DIR}/app ${ANDROID_MANIFEST}) #calculate ${OUTPUT_DIR}/app relative path to ${ANDROID_MANIFEST}
    # store the relative path at ANDROID_MANIFEST
...
if(NOT ${ASSETS_LIST})
    set(ASSETS_SRC_DIR "assets.srcDirs += [ '${ASSETS_LIST}' ]")
endif()
